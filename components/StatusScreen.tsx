  ...
  return (
    <div className="min-h-screen w-full relative">
      ...
      <footer className="w-full py-10 flex flex-col items-center justify-center gap-2 relative z-10 border-t border-white/5 mt-auto">
        ...
        <p className="text-white/20 text-[10px] uppercase font-bold tracking-tighter mt-2">© 2026 ISFORTNITE.ONLINE | ALL RIGHTS RESERVED | Build: v8.1.0 (FINAL_RELIABLE)</p>
      </footer>
    </div>
  );
};
